import H1Mobile from '../assets/images/home/hero/avenrow-hero-640.webp'
import H1Fallback from '../assets/images/home/hero/avenrow-hero.png'
import F1Fallback from '../assets/images/home/featured/braised-short-rib.png'
import F2Fallback from '../assets/images/home/featured/atlantic-salmon.png'
import F3Fallback from '../assets/images/home/featured/mushroom-rigatoni.png'
import I1Fallback from '../assets/images/home/story/restaurant-interior.png'
import G1Fallback from '../assets/images/home/gallery/dining-corner.png'
import G2Fallback from '../assets/images/home/gallery/hands-plating.png'
import G3Fallback from '../assets/images/home/gallery/cocktail.png'
import G4Fallback from '../assets/images/home/gallery/table-setting.png'
...
// Approved PNG masters remain untouched; responsive WebP is preferred, with original PNG fallback for older decoders.
// Featured photos use empty alt because adjacent dish copy supplies their meaning.
export const homeImages = {
  H1: {
    id: 'H1', fallback: H1Fallback, src: H1Large,
    srcSet: `${H1Mobile} 640w, ${H1Small} 960w, ${H1Large} 1536w`,
  ...
  F1: {
    id: 'F1', fallback: F1Fallback, src: F1Large,
  ...
  F2: {
    id: 'F2', fallback: F2Fallback, src: F2Large,
    srcSet: `${F2Small} 640w, ${F2Large} 1280w`,
    sizes: "(min-width: 1340px) 418px, (min-width: 1024px) 34vw, (min-width: 640px) calc(50vw - 48px), calc(100vw - 40px)",
    width: 1280, height: 960, alt: "",
  },
  F3: {
    id: 'F3', fallback: F3Fallback, src: F3Large,
    srcSet: `${F3Small} 640w, ${F3Large} 1280w`,
    sizes: "(min-width: 1340px) 418px, (min-width: 1024px) 34vw, (min-width: 640px) calc(50vw - 48px), calc(100vw - 40px)",
    width: 1280, height: 960, alt: "",
  },
  I1: {
    id: 'I1', fallback: I1Fallback, src: I1Large,
  ...
  G1: {
    id: 'G1', fallback: G1Fallback, src: G1Large,
  ...
  G2: {
    id: 'G2', fallback: G2Fallback, src: G2Large,
  ...
  G3: {
    id: 'G3', fallback: G3Fallback, src: G3Large,
  ...
  G4: {
    id: 'G4', fallback: G4Fallback, src: G4Large,
